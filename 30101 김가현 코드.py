...
try:
    plasmid_size = int(input("플라스미드 크기 (1,000~10,000bp): "))
    dna_concentration = float(input("DNA 농도 (1~1,000ng/μL): "))
    voltage = float(input("전압 (0~250V): "))
    gel_concentration = float(input("젤 농도 (0.5~2.5%): "))
